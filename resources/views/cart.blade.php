...
@section('content')
  <main class="pt-90">
    ...
    <div class="qty-control position-relative">
        ...
        <form method="POST" action="{{route('cart.reduce.qty',['rowId'=>$item->rowId])}}">
            @csrf
            @method('PUT')
    ...
    @csrf
    @method('DELETE')
    <button class="btn btn-light" type="submit">ELIMINAR CARRITO</button>
</form>
          </div>
        </div>
            ...
            <div class="shopping-cart__totals">
              ...
              <table class="cart-totals">
               <tbody>
                  <tr>
                    <th>Subtotal</th>
                    <td>S/{{Cart::instance('cart')->subtotal()}}</td>
                  </tr>
                  <tr>
                    <th>Shipping</th>
                    <td>Free</td>
                  ...
                  <tr>
                    <th>VAT</th>
                    <td>S/{{Cart::instance('cart')->tax()}}</td>
                  </tr>
                  <tr>
                    <th>Total</th>
                    <td>S/{{Cart::instance('cart')->total()}}</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        @else
            <div class="row">
                <div class="col-md-12 text-center pt-5 bp-5">
                    ...
                    <a href="{{route('shop.index')}}" class="btn btn-info">Ir a tienda</a>
                </div>
            </div>
