...
@section('content')
  <main class="pt-90">
              ...
              <div class="checkout__totals">
                ...
                <table class="checkout-totals">
                  <tbody>
                    ...
                    <tr>
                      <th>VAT</th>
                      <td align="right">S/{{Cart::instance('cart')->tax()}}</td>
                    </tr>
                    <tr>
                      <th>TOTAL</th>
                      <td align="right">S/{{Cart::instance('cart')->total()}}</td>
                    </tr>
                  </tbody>
                </table>
    ...
    @csrf
    <button type="submit" class="btn btn-primary btn-checkout">Realizar pedido</button>
</form>
            </div>
          </div>
        </div>
