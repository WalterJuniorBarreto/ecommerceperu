          ...
          <div class="accordion-item mb-4">
            ...
            <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
              ...
              <input class="price-range-slider" type="text" name="price_range" value="" data-slider-min="1"
                data-slider-max="1000" data-slider-step="5" data-slider-value="[{{$min_price}},{{$max_price}}]" data-currency="S/" />
              <div class="price-range__info d-flex align-items-center mt-2">
                ...
                <div>
                  ...
                  <span class="price-range__max">S/1000</span>
                </div>
              </div>
            </div>
          </div>
...
<div class="shop-list flex-grow-1">
                ...
                <div class="slide-split_text position-relative d-flex align-items-center"
                  ...
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      ...
                      Men/Women<br /><strong>Ropa & sneakers</strong></h2>
                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Descubre las mejores prendas para tu estilo único y combina con sneakers que marcan tendencia. Completa tu look con actitud.</h6>
                  </div>
                </div>
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #7F8C8D;">
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1" >
            ...
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Sort Items"
              ...
              <option value="-1" {{$order == -1 ? 'selected' : ''}}>Seleccionar</option>
  ...
  <form id="frefilter" action="{{route('shop.index')}}">
    
    <input type="hidden" name="page" value="{{$products->CurrentPage()}}">
    <input type="hidden" name="size" id="size" value="{{$size}}">
    <input type="hidden" name="order" id="order" value="{{$order}}">
    <input type="hidden" name="brands" id="chkBrands">
...
@push('scripts')
  ...
  <script>
    ...
    if (slider && typeof $ !== 'undefined') {
      $(slider).on('slideStop', function (e) {
        // e.value es un array con el rango seleccionado [min, max]
        document.getElementById('hdnMin').value = e.value[0];
        document.getElementById('hdnMax').value = e.value[1];

        // También puedes actualizar visualmente los valores si lo deseas
        document.querySelector('.price-range__min').textContent = 'S/' + e.value[0];
        document.querySelector('.price-range__max').textContent = 'S/' + e.value[1];


        document.getElementById('frefilter').submit();
      });
    }
  });
  </script>
