                                            ...
                                            <fieldset class="name">
                                                ...
                                                <div class="select mb-10">
                                                    <select class="" name="stock_status">
                                                        <option value="instock" {{$product->stock_statu == "instock" ? "selected":""}}>InStock</option>
                                                        <option value="outofstock" {{$product->stock_statu == "outofstock" ? "selected":""}}>Out of Stock</option>
                                                    </select>
                                                </div>
                                            </fieldset>
...
@push('scripts')
    ...
    if(file){
        ...
        $('#imgpreview img').attr('src', url).show();
    }
});
