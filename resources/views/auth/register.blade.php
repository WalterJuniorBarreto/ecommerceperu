          ...
          <div class="register-form">
            <form method="POST" action="{{route('register')}}" name="register-form" class="needs-validation" novalidate="">
              ...
              <div class="d-flex align-items-center mb-3 pb-2">
                <p class="m-0">Tus datos personales se utilizarán para respaldar tu experiencia en este sitio web, para gestionar el acceso a tu cuenta y para otros fines descritos en nuestra política de privacidad.</p>
              </div>
              ...
              <div class="customer-option mt-4 text-center">
                ...
                <a href="{{route('login')}}" class="btn-text js-show-register">Iniciar sesion con tu cuenta</a>
              </div>
            </form>
          </div>
        </div>
