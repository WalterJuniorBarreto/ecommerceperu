...
@section('content')
          ...
          <div class="overflow-hidden position-relative h-100">
            ...
            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
              <h6 class="text_dash text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3">
                Nuevos Productos</h6>
              <h2 class="h1 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5">Ropa</h2>
              <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">Zapatillas</h2>
              <a href="#"
          ...
          <div class="overflow-hidden position-relative h-100">
            <div class="slideshow-character position-absolute bottom-0 pos_right-center">
              ...
              <div class="character_markup">
                <p class="text-uppercase font-sofia fw-bold animate animate_fade animate_rtl animate_delay-10">Verano
                </p>
              </div>
            </div>
            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
        ...
        <div class="swiper-slide">
          <div class="overflow-hidden position-relative h-100">
            ...
            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
              <h6 class="text_dash text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3">
                Nuevos Productos</h6>
              <h2 class="h1 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5">Zapatillas</h2>
              <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">Electrodomesticos</h2>
              <a href="#"
                class="btn-link btn-link_lg default-underline fw-medium animate animate_fade animate_btt animate_delay-7">Comprar
                Ahora</a>
            </div>
          </div>
        </div>
    ...
    <div class="container mw-1620 bg-white border-radius-10">
      ...
      <section class="category-carousel container">
        <h2 class="section-title text-center mb-3 pb-xl-2 mb-xl-4">Productos preferidos</h2>
                  ...
                  <div class="swiper-slide product-card product-card_style3">
                    ...
                    <div class="pc__info position-relative">
                      ...
                      <div class="product-card__price d-flex">
                        <span class="money price text-secondary">  @if($sproduct->sale_price)
                      <s>S/{{$sproduct->regular_price}}</s> S/{{$sproduct->sale_price}}
                    @else
              ...
              <div class="pc__info position-relative">
                ...
                <div class="product-card__price d-flex align-items-center">
                  <span class="money price text-secondary">@if($fproduct->sale_price)
                      <s>S/{{$fproduct->regular_price}}</s> S/{{$fproduct->sale_price}}
                    @else
